...
description: "Core distinctions, types of reliability and validity, why they matter, and practical interpretation notes."
authors: ["Daniel B. Altieri"]
date: "2026-01-27"
tags: ["reliability","validity","measurement","research design"]
toc: true
---
...
**Illustration** (target diagram):
- Unreliable & invalid: scattered and far from center.
- Reliable but invalid: tight cluster off the bullseye.
- Valid but unreliable: spread out but centered.
- Reliable & valid: tight cluster on the bullseye.
...
- Consistency across time. Same measure to same participants at two time points.
- **Categorical**: % agreement. **Continuous**: correlation across time.

### Parallel Forms Reliability
- Create equivalent versions of a test; scores should correspond across forms.

### Internal Consistency Reliability
- How well items in a measure relate to one another.
- **Average inter‑item correlation**, **item–total correlation**, **Cronbach’s alpha**.
...
- **Translational**: Face validity; Content validity.
...
**Q: What counts as a “good” Cronbach’s alpha?**  
**A:** Context matters (purpose, stakes, construct breadth). Rather than a hard cutoff, consider item quality, dimensionality, and alternative reliability estimates.

**Q: Face vs. Content validity—what’s the difference?**  
**A:** **Face**: does it *look* right to experts/users? **Content**: does it *cover the full domain* of the construct (by design/specification)?
