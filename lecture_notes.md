...
## Week5
---
title: "Survey Data and Analysis"
...
fontsize: 11pt
---
# Survey Data & Analysis — Study Notes
...
Survey data is collected by **asking people questions and recording their responses**.  
It is one of the most widely used forms of data in social science because it allows researchers to systematically gather information about behaviors, attitudes, and demographic characteristics from large groups of people. Surveys are especially useful when direct observation is impractical or impossible. [1] Async Lecture Introduction to Surveys)
...
In practice, it is rarely possible to survey an entire population. Instead, researchers collect data from a **sample**, which is a subset of the population. The goal of sampling is to gather information from a smaller group in a way that still reflects the larger population. [1] Async Lecture Introduction to Surveys)

### 2.2 Probability Sampling
A **probability sample** is one in which the probability that any individual is selected into the sample is known. This is critical because it allows researchers to generalize results beyond the people who happened to respond to the survey. Without probability sampling, survey results may only describe the sample itself. [1] Async Lecture Introduction to Surveys)

### 2.3 Survey Weights
When different people have different probabilities of being sampled, **survey weights** are used. Weights adjust the data so that each respondent represents the appropriate number of people in the population. Large national surveys such as the GSS rely on weights to produce accurate population estimates. [1] Async Lecture Introduction to Surveys)
...
### 3.1 Overview
The **General Social Survey (GSS)** is a long-running national survey of adults in the United States. It collects data on a wide range of topics, including education, health behaviors, and social attitudes. Because it has been conducted for decades using consistent methods, it is especially valuable for social research. [1] Async Lecture Introduction to Surveys)

### 3.2 Codebooks
A **codebook** is an essential companion to any survey dataset. It documents how variables are constructed, what questions were asked, which responses were allowed, and who was or was not asked each question. Proper use of survey data always begins with understanding the codebook. [1] Async Lecture Introduction to Surveys)[2] Async Lecture on Survey Analysis)
...
Open-ended questions allow respondents to answer in their own words. While they can capture nuance and depth, they produce text data that is difficult to analyze statistically and often require qualitative methods. [1] Async Lecture Introduction to Surveys)

### 4.2 Closed-Ended / Multiple Choice Questions
Closed-ended and multiple-choice questions limit responses to predetermined options. These questions dominate survey research because they standardize responses and make quantitative analysis possible and efficient. [1] Async Lecture Introduction to Surveys)

### 4.3 Other Question Formats
Surveys may also include ranking tasks, forced-choice questions, or numeric sliders. These formats can be useful in specific contexts but usually require additional care in both design and analysis. [1] Async Lecture Introduction to Surveys)
...
Demographic variables describe stable characteristics of individuals, such as education or age. These are often treated as **independent variables** because they influence other outcomes but usually are not caused by them. [1] Async Lecture Introduction to Surveys)[2] Async Lecture on Survey Analysis)

### 5.2 Behavioral Variables
Behavioral variables measure what people **do**, often within a defined time period. Questions about doctor visits, voting, or library use are behavioral and focus on observable actions. [2] Async Lecture on Survey Analysis)

### 5.3 Attitudinal Variables
Attitudinal variables capture how people **think or feel** about issues. These questions measure beliefs, opinions, and values rather than actions and must be clearly distinguished from behavioral questions. [2] Async Lecture on Survey Analysis)

---

## 6. Question Design Principles
Good survey data depends heavily on good question design. Poorly worded questions can bias responses or confuse participants, leading to misleading results. Careful design improves both validity and reliability. [1] Async Lecture Introduction to Surveys)

### Key Guidelines
- Keep questions concise and focused  
- Avoid leading or loaded wording  
- Use clear and commonly understood language  
- Provide complete and mutually exclusive response options  
- Do not combine behaviors and attitudes in one question [1] Async Lecture Introduction to Surveys)
...
### 7.1 Data Layout
Survey data files are typically rectangular: rows represent individual respondents and columns represent variables. Understanding this structure is essential before beginning any analysis. [2] Async Lecture on Survey Analysis)

### 7.2 Labels vs. Numeric Codes
Many survey datasets use numeric codes to represent categories. Although these appear as numbers, they should not be treated as numeric quantities; they are simply labels for categories. [2] Async Lecture on Survey Analysis)
...
### What Is a Crosstab?
A **crosstabulation** compares two categorical variables to reveal how they are related. Crosstabs are one of the most common and interpretable tools for analyzing survey data.

### Best Practice
To interpret results correctly:
- Place the **independent variable** on the rows  
- Place the **dependent variable** on the columns  
- Use **row percentages** to compare groups [2] Async Lecture on Survey Analysis)
---
